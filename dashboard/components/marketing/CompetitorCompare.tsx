...
export function CompetitorCompare() {
  return (
    <section id="compare" className="zdb-section" style={{ padding: '88px 40px', background: '#fff' }}>
      <div style={container(980)}>
        ...
        <div style={{ overflowX: 'auto', marginBottom: 28, borderRadius: 16, border: `1px solid ${M.line}` }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 640 }}>
            ...
            <tbody>
              {ROWS.map(([cap, ...vals]) => (
                <tr key={cap}>
                  <td style={{
                    padding: '12px 16px', fontSize: 13, fontWeight: 600, color: '#000',
                  ...
                  {vals.map((v, j) => (
                    <td
                      key={j}
                      style={{
                        padding: '12px 16px', textAlign: 'center', fontSize: 15, fontWeight: 800,
        ...
        <p style={{ textAlign: 'center', fontSize: 13, fontWeight: 600, color: '#000', margin: '0 0 20px' }}>
