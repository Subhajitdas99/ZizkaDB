  ...
  return (
    <section id="demo" className="zdb-section" style={{ padding: '88px 40px', background: '#fff' }}>
      <div style={container(980)}>
        ...
        <div className="zdb-compare-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          <ComparePanel
...
function ComparePanel({
  ...
  return (
    <div style={{
      ...
      boxShadow: highlight ? '0 16px 48px rgba(249,115,22,0.1)' : '0 4px 20px rgba(15,23,42,0.04)',
    }}>
      <div style={{
        padding: '18px 20px',
